...
class CustomerLoginScreen:
    def __init__(self, root, on_login_success=None):
        ...
        # Configure window
        self.root.title("KayaKonnect - Login")
    ...
    def login_user(self):
        ...
        if success:
            ...
            if user_data.get('user_type') != 'customer':
                self.show_error("Invalid account type. Use Kaya login.")
                return
            ...
            if self.on_login_success:
                ...
                print(f"✅ Login successful! User: {user_data}")
        else:
    ...
    def on_signup_click(self, event):
        """Handle signup link click - navigate to customer register"""
        from ui.customer_register import CustomerRegisterScreen
        ...
        new_root = ctk.CTk()
        register = CustomerRegisterScreen(new_root)
        new_root.mainloop()
...
if __name__ == "__main__":
    root = ctk.CTk()
    login = CustomerLoginScreen(root)
    root.mainloop()